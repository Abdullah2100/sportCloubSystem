...
namespace SportCllubeBuisness
{
    ...
    {
      public enum enPoepleMode { add, update};
        public enPoepleMode mode {  get; set; }
        ...
        private clsPeopleBuisness(enPoepleMode mode, int id, string firstName, string secondName, string thirdName, string familyName, DateTime brithday, bool gender, int nationalityID, string address, string phone)
        {
            this.mode = mode;
            this.id = id;
        ...
        public static  clsPeopleBuisness findPeopleByID (int id)
        {
            ...
            if(clsPeoplesData.findPeoplesByID(id,ref  firstName,ref  secondName, ref thirdName,ref  familyName,ref  brithday,ref gender, ref nationalityID,ref  address,ref phone))
            {
                ...
                return new clsPeopleBuisness(enPoepleMode.update,id, firstName, secondName, thirdName, familyName, brithday, gender, nationalityID, address, phone);
            }
            return null;
        }
